...
eval-best: ## Watch trained ghosts (best checkpoint by tail-mean reward) in a Pygame window
	$(PYTHON) custom_environment/eval.py --learner $(LEARNER) --checkpoint-select best
